...
include_once plugin_dir_path(__FILE__) . 'includes/ResourceFilterDisplayAjax.php';

// Include the admin dashboard filters.
include_once plugin_dir_path(__FILE__) . 'admin/resources-admin-dashboard-filters.php';
