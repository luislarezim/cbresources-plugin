...
function display_filtered_resources($resource_type = '', $industry = '', $role = '', $paged = 1)
{
    ...
    $query_args = array(
        ...
        'paged' => max(1, filter_var($paged, FILTER_VALIDATE_INT)), // Add the paged parameter with proper validation.
    );
        ...
        while ($query->have_posts()) :
            ...
            <a class="blogitem" href="<?php the_permalink(); ?>">
                <div class="blogitem-imgwrap">
                    ...
                    ?>
                    <img class="blogitem-img" src="<?php echo esc_url($image_url); ?>" alt="<?php the_title_attribute();?>" />
                </div>
